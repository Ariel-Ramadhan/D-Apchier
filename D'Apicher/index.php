    ...
    <div class="navbar">    
        ...
        <div class="menuNav">
            ...
            if (!isset($_SESSION['admin_username'])){
                echo '<a href="./login.php"><strong>Sign in</strong></i></a>';
            } else {
                echo '<a href="./acc.php"><i class="fa-solid fa-user-large"></i>&nbsp ' . $_SESSION["admin_username"] . '</a>';
            }
            ?>
...
<div class="menu">
    ...
    <?php
            // if (isset($_SESSION['admin_username'])){
            //     echo '<a href="./wl.php">Wishlist</a>';
            // } else {
            //     echo '<a href="./login.php">Wishlist</a>';
            // }
    ?>
...
<div id="recent">
        ...
        <div class="recent">
            <form action="">
                ...
                ?>
                    <div class="card">
                        <a href="content.php?product=<?php echo $produk['judul'] ?>"><img src="image/<?php echo $produk['gambar'] ?>" alt="*" height="300px" width="100%" class="iconG"></a>
                        <h2><a href="content.php?product=<?php echo $produk['judul'] ?>"><?php echo $produk['judul']; ?></a></h2>
